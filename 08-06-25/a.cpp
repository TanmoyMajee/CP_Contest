...
// At time 0, the door is open, so Yousef passes.At time 1, the door is closed, Yousef can use the button now and pass through the door.At time 2, the button's effect is still on, so Yousef can still pass. At time 3, the button's effect has finished, but the door is open. Yousef passes and reaches the exit. In the second test case, Yousef has a 3 - second button, but he would need at least a 4 - second button to reach the exit.Therefore, the answer is NO.

//                                                                                                                                                                                                                                                                                                                                                                                                                                                        In the third test case,
//     Yousef can turn on the button before starting to move.All the doors will stay open until he reaches the exit.
